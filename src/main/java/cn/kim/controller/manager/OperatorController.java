...
public class OperatorController extends BaseController {
    ...
    /***********    sub登录账号信息表  ***********/
    @GetMapping("/sub/add")
    @RequiresPermissions(value = {"SYSTEM:OPERATOR_SUB_INSERT", "INFO:DIVISION_PERSONNEL_SET_SUB", "INFO:DEPARTMENT_PERSONNEL_SET_SUB", "INFO:CLASS_SET_SUB", "INFO:TEACHER_SET_SUB", "STUDENT:BASE_SET_SUB"}, logical = Logical.OR)
    @Token(save = true)
    ...
    @RequiresPermissions(value = {"SYSTEM:OPERATOR_SUB_UPDATE", "INFO:DIVISION_PERSONNEL_SET_SUB", "INFO:DEPARTMENT_PERSONNEL_SET_SUB", "INFO:CLASS_SET_SUB", "INFO:TEACHER_SET_SUB", "STUDENT:BASE_SET_SUB"}, logical = Logical.OR)
    ...
    @RequiresPermissions(value = {"SYSTEM:OPERATOR_SUB_DELETE", "INFO:DIVISION_PERSONNEL_SET_SUB", "INFO:DEPARTMENT_PERSONNEL_SET_SUB", "INFO:CLASS_SET_SUB", "INFO:TEACHER_SET_SUB", "STUDENT:BASE_SET_SUB"}, logical = Logical.OR)
    ...
    @GetMapping("/roles")
    @RequiresPermissions(value = {"SYSTEM:OPERATOR_SET_ROLE", "INFO:DIVISION_PERSONNEL_SET_ROLE", "INFO:DEPARTMENT_PERSONNEL_SET_ROLE", "INFO:CLASS_SET_ROLE", "INFO:TEACHER_SET_ROLE", "STUDENT:BASE_SET_ROLE"}, logical = Logical.OR)
    @ResponseBody
