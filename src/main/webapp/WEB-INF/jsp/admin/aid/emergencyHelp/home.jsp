...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${EMERGENCY_HELP_ADD_URL}', {}, function (html) {
                model.show({
                    title: '添加应急求助',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${EMERGENCY_HELP_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${EMERGENCY_HELP_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改应急求助',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${EMERGENCY_HELP_UPDATE_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#del', function () {
        ...
        model.show({
            ...
            isConfirm: true,
            confirm: function ($model) {
                ajax.del('${EMERGENCY_HELP_DELETE_URL}/' + id, {}, function (data) {
                    ajaxReturn.data(data, $model, $dataGrid, false);
                })
            }
        });
    ...
    function excelImport($form, $model) {
        ajax.file('${EMERGENCY_HELP_IMPORT_URL}', $form, function (data) {
            //重置上传框
            importFileClear();
            ajaxReturn.data(data, $model, $dataGrid, true, {
                error: function () {
