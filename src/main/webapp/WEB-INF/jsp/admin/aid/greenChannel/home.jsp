...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${GREEN_CHANNEL_ADD_URL}', {}, function (html) {
                model.show({
                    title: '添加绿色通道',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${GREEN_CHANNEL_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${GREEN_CHANNEL_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改绿色通道',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${GREEN_CHANNEL_UPDATE_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#del', function () {
        ...
        model.show({
            ...
            isConfirm: true,
            confirm: function ($model) {
                ajax.del('${GREEN_CHANNEL_DELETE_URL}/' + id, {}, function (data) {
                    ajaxReturn.data(data, $model, $dataGrid, false);
                })
            }
        });
    ...
    function excelImport($form, $model) {
        ajax.file('${GREEN_CHANNEL_IMPORT_URL}', $form, function (data) {
            //重置上传框
            importFileClear();
            ajaxReturn.data(data, $model, $dataGrid, true, {
                error: function () {
