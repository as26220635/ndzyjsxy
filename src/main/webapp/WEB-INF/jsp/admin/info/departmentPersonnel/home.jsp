...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_ADD_URL}', {}, function (html) {
                model.show({
                    title: '添加部门人员',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改部门人员',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_UPDATE_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#accountInfo', function () {
        ...
        ajax.getHtml('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_ADDOUNT_INFO_URL}/' + SO_ID, {}, function (html) {
                model.show({
                    title: '账号信息',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_ADDOUNT_INFO_URL}', params, function (data) {
                            ajaxReturn.data(data, $model, $dataGrid, false);
                        });
                    }
                });
    ...
    $dataGridTable.find('tbody').on('click', '#resetPassword', function () {
        ...
        model.show({
            ...
            confirm: function ($model, password) {
                ajax.put('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_RESET_PWD_URL}', {ID: id, PASSWORD: password}, function (data) {
                    ajaxReturn.data(data, $model, null, null);
                });
            }
        });
    ...
    $dataGridTable.find('tbody').on('click', '#del', function () {
        ...
        model.show({
            ...
            isConfirm: true,
            confirm: function ($model) {
                ajax.del('${BASE_URL}${Url.DEPARTMENT_PERSONNEL_DELETE_URL}/' + id, {}, function (data) {
                    ajaxReturn.data(data, $model, $dataGrid, false);
                })
            }
        });
