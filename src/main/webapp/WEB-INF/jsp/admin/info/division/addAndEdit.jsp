...
<form id="addAndEditForm">
    ...
    <div class="form-group has-feedback">
        <label>部门名称:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_NAME")}
    ...
    <div class="form-group has-feedback form-group-md-6">
        <label>手机:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_PHONE")}
               value="${division.BD_PHONE}">
    </div>
    <div class="form-group has-feedback form-group-md-6">
        <label>固定电话:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_FIXED_PHONE")}
               value="${division.BD_FIXED_PHONE}">
    </div>
    <div class="form-group has-feedback form-group-md-6">
        <label>邮箱:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_EMAIL")}
               value="${division.BD_EMAIL}">
    </div>
    <div class="form-group has-feedback">
        <label>地址:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_ADDRESS")}
               value="${division.BD_ADDRESS}">
    </div>
    <div class="form-group has-feedback">
        <label>描述:</label>
        <textarea ${fns:validField(TableName.BUS_DIVISION,"BD_DESCRIBE")}
                class="form-control form-textarea"
                rows="3">${division.BD_DESCRIBE}</textarea>
    </div>
    <div class="form-group has-feedback ">
        <label>排序:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.BUS_DIVISION, "BD_ORDER")}
