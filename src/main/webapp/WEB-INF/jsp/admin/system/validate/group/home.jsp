...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${BASE_URL}${Url.VALIDATE_GROUP_ADD_URL}', {SV_ID: '${EXTRA.SV_ID}'}, function (html) {
                model.show({
                    title: '添加验证组',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${BASE_URL}${Url.VALIDATE_GROUP_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${BASE_URL}${Url.VALIDATE_GROUP_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改验证组',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${BASE_URL}${Url.VALIDATE_GROUP_UPDATE_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#del', function () {
        ...
        model.show({
            ...
            isConfirm: true,
            confirm: function ($model) {
                ajax.del('${BASE_URL}${Url.VALIDATE_GROUP_DELETE_URL}/' + id, {}, function (data) {
                    ajaxReturn.data(data, $model, $dataGrid, false);
                })
            }
        });
