...
<script>
    ...
    $('#addBtn').on('click', function () {
        ajax.getHtml('${BASE_URL}${Url.OPERATOR_SUB_ADD_URL}', {SO_ID: '${EXTRA.SO_ID}'}, function (html) {
                model.show({
                    title: '添加操作员账号',
                    content: html,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.post('${BASE_URL}${Url.OPERATOR_SUB_ADD_URL}', params, function (data) {
    ...
    $dataGridTable.find('tbody').on('click', '#edit', function () {
        ...
        ajax.getHtml('${BASE_URL}${Url.OPERATOR_SUB_UPDATE_URL}/' + id, {}, function (html) {
                model.show({
                    title: '修改操作员账号',
                    content: html,
                    footerModel: model.footerModel.ADMIN,
                    ...
                    confirm: function ($model) {
                        ...
                        ajax.put('${BASE_URL}${Url.OPERATOR_SUB_UPDATE_URL}', params, function (data) {
                            ajaxReturn.data(data, $model, $dataGrid, false);
                        });
                    }
                });
    ...
    $dataGridTable.find('tbody').on('click', '#del', function () {
        ...
        model.show({
            ...
            isConfirm: true,
            confirm: function ($model) {
                ajax.del('${BASE_URL}${Url.OPERATOR_SUB_DELETE_URL}/' + id, {}, function (data) {
                    ajaxReturn.data(data, $model, $dataGrid, false);
                })
            }
        });
    ...
    function onSwitchChange($this, field, check, IS_STATUS) {
        ...
        ajax.put('${BASE_URL}${Url.OPERATOR_SUB_SWITCH_STATUS_URL}', {ID: $this.val(), IS_STATUS: IS_STATUS}, function (data) {
