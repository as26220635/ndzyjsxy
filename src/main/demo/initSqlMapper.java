...
public class initSqlMapper {
    ...
    public static void main(String[] args) throws IOException {
        //字段
        String str = "ID\tBS_ID\tBSC_YEAR\tBSC_SEMESTER\tBSC_TOTAL\tBSC_RANK\tBSC_POLITICAL_ATTITUDE\tBSC_LABOR_ATTITUDE\tBSC_COMPLIANCE\tBSC_COLLECTIVE\tBSC_DECORUM\tBSC_CARE\tBSC_PERSONAL_QUALITY\tBSC_SERVICE_SPIRIT\tBSC_FULL_WORK\tBSC_BONUS_POINTS\tBSC_EDUCATION_DEDUCTION\tBSC_EDUCATION_TOTAL\tBSC_EDUCATION_SCORE\tBSC_ACADEMIC_RECORD\tBSC_INTELLECTUAL_POINTS\tBSC_INTELLECTUAL_SCORE\tBSC_INTELLECTUAL_RANK\tBSC_VOLUNTEER_TOTAL\tBSC_VOLUNTEER_SCORE\tBSC_REMARKS";
        //表名
        String tablename = "BUS_STUDENT_COMPREHENSIVE";
